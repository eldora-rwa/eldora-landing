  ...
  terms: {
    ...
    content: {
      [`1. Acceptance of Terms`]: [
        ...
        `These Terms of Use ("Terms") govern your access to and use of the Eldora (WeWorld Development AG) website, dashboard, and any products, tools, or services provided through Eldora (collectively, the "Platform").`,
    ...
    <article className="mx-auto max-w-4xl">
      ...
      {activeNav === "legal" ? (
        <p className="mb-8 leading-7 text-muted-foreground">
          Use of Eldora and participation in RWA projects or
