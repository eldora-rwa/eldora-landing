  ...
  "blocks": [
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          "4",
          "Observatory",
          "Market intelligence · Live data · AI insights"
        ],
        [
          "5",
          "Discover Assets",
        ...
        [
          "8",
          "DEX — Swap & Bridge",
          "Token swaps · Cross-chain bridging"
        ],
        [
          "9",
          "Leaderboard",
          "Leaderboard & $20K Campaign"
        ],
        [
          "10",
          "Security & Compliance",
          "Custody · KYC/AML · Wallet safety"
        ],
        [
          "11",
          "Supported Networks",
    ...
    },
    {
      ...
      "rows": [
        [
          "T1",
          "Terms of Use",
          "Eligibility · Liability · Governing law"
        ],
        [
          "T2",
          "Privacy Policy",
          "GDPR · Swiss FADP · Your data rights"
        ],
        [
          "T3",
        ...
        [
          "T4",
          "Contact & Support",
          "All support channels · Community links"
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          "Community Members",
          "20,000+ across X, Discord, Telegram"
        ],
        [
          "T-Bill APY",
          "~5.3% on idle capital (variable, tracks Fed rates)"
        ],
        [
          "Active Reward Pool",
          "$20,000 — 12-week trading campaign"
        ],
        [
          "Supported Networks",
          "Ethereum, Base, Polygon, Arbitrum, BNB Chain"
        ...
        [
          "Minimum Investment",
          "From $1 — fractional positions supported"
        ],
        [
          "KYC",
          "One-time verification unlocks all chains and products"
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      "rows": [
        [
          "1",
          "Go to app.eldora.do in your browser or open the mobile app."
        ],
        [
          "2",
        ...
        [
          "3",
          "Approve the wallet connection request inside your wallet app."
        ],
        [
          "4",
    ...
    },
    {
      ...
      "rows": [
        [
          "1",
          "Navigate to Account → Identity Verification in the dashboard."
        ],
        [
          "2",
    ...
    },
    {
      ...
      "rows": [
        [
          "1",
          "Visit app.eldora.do — no login required."
        ],
        [
          "2",
          "Click 'Try Ghost Portfolio' on the home screen."
        ],
        [
          "3",
          "You receive a simulated starting balance to allocate."
        ],
        [
          "4",
        ...
        [
          "5",
          "Track performance in real time from the Portfolio page."
        ],
        [
          "6",
    ...
    },
    {
      ...
      "rows": [
        [
          "",
          "Eldora Tokenized Equities",
          "Synthetic / Derivative Products"
        ],
        [
          "Backing",
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          "Financial",
          "IBKR, JPM, GS, BAC — banking and financial services"
        ],
        [
          "Healthcare",
          "JNJ, PFE, ABBV — pharmaceutical and medical"
        ],
        [
          "Energy",
          "XOM, CVX — major oil & gas majors"
        ],
        [
          "Broad Market ETFs",
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          "APY",
          "~5.3% variable (tracks US Federal Reserve benchmark rates)"
        ],
        [
          "Supported Assets",
          "USDC and USDT"
        ...
        [
          "Minimum Deposit",
          "None — start with any amount"
        ],
        [
          "Lock-up Period",
          "None — withdraw at any time"
        ],
        [
          "Yield Accrual",
          "Daily, compounding automatically"
        ],
        [
          "Availability",
          "All five supported networks, 24/7"
        ],
        [
          "Risk Level",
    ...
    },
    {
      ...
      "rows": [
        [
          "Asset",
          "Variable APY — Total Borrowed"
        ],
        [
          "USDT",
          "3.49% APY — $1.97B total borrowed"
        ],
        [
          "USDC",
          "4.02% APY — $1.87B total borrowed"
        ],
        [
          "RLUSD",
          "2.85% APY — $133.4M total borrowed"
        ],
        [
          "USDe",
          "2.96% APY — $226.4M total borrowed"
        ],
        [
          "USDtb",
          "3.11% APY — $146.1M total borrowed"
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      "rows": [
        [
          "1",
          "Navigate to Dex in the left sidebar."
        ],
        [
          "2",
          "Select the token you want to sell from the SELL dropdown."
        ],
        [
          "3",
          "Select the token you want to receive from the BUY dropdown."
        ],
        [
          "4",
          "Enter the amount."
        ...
        [
          "5",
          "Review the quoted rate, estimated price impact, and gas fee."
        ],
        [
          "6",
          "Click 'Review Swap', then confirm in your wallet."
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          "Campaign Duration",
          "12 weeks starting early June 2026"
        ],
        [
          "Leaderboard",
          "Live and public at app.eldora.do/leaderboard"
        ],
        [
          "Reward Allocation",
        ...
        [
          "Eligibility",
          "All KYC-verified users in supported countries"
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          "Ethereum",
          "$2 – $20+ per transaction (highest, highly variable)"
        ],
        [
          "Arbitrum",
    ...
    },
    {
      "type": "paragraph",
      "style": "Heading 1",
      "text": "T3. Risk Disclosure Statement"
    },
    {
      "type": "paragraph",
      "style": "normal",
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          "In-App Chat",
          "Live support chat at app.eldora.do (coming soon)"
        ],
        [
          "Email",
          "hello@eldora.do"
        ...
        [
          "Twitter / X",
          "https://x.com/eldoraglobal"
        ],
        [
          "Telegram",
          "Official community: t.me/Eldoracommunity"
        ],
        [
          "Discord",
          "https://discord.com/invite/M8eYkEDN76"
        ]
      ]
    },
    {
