    ...
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        const submitResponse = await fetch(
          `${API_BASE_URL}/api/early-access/submit`,
          {
            method: "POST",
            headers: {
        ...
        if (!submitResponse.ok || !submitData.success) {
          ...
          const isAlreadyRegistered = submitData.message
            ?.toLowerCase()
            ...
            <>
              <DialogHeader>
                <DialogTitle className="text-center text-xl font-semibold">
                  Limited Access for Eldora Beta Test
                </DialogTitle>
                <p className="text-center text-sm text-gray-600 mt-3 px-2">
                  Secure your spot to get early access to Eldora's seamless
                  all-in-1 RWA investment experience.
                </p>
              </DialogHeader>
